...
OBSIDIAN_FOLDER = "PXN Deal Scout"

# GitHub Pages 输出目录（本地 repo 路径）
SITE_OUTPUT_DIR = r"C:\Users\zxr\Documents\pxn_deal_scout\docs"
...
<head>
<meta charset="utf-8" />
<title>PXN Deal Scout — {today}</title>
...
<header>
  <div>
    ...
    <div class="logo-title">Deal Scout</div>
  </div>
...
def save_to_obsidian(analysis_text, vault_path, folder_name, today):
    ...
    filepath = os.path.join(folder, f"{today} Deal Scout.md")
    content = f"# PXN Deal Scout — {today}\n\n*Auto-generated by deal_scout.py*\n\n---\n\n{json.dumps(analysis_text, indent=2)}\n"
